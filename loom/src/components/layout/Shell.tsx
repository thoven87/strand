...
const SECTIONS: NavSection[] = [
    {
        ...
        items: [
            ...
            { subPath: "/runs", icon: <Workflow size={15} />, label: "Runs" },
            {
                subPath: "/events",
        ...
        <Link
            ...
            className={cn(
                ...
                active
                    ...
                    : "text-muted-foreground hover:bg-sidebar-item-active/60 hover:text-foreground",
            )}
        >
...
export function Shell({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="flex h-full w-full overflow-hidden">
            ...
            <aside
                className={cn(
                    "flex flex-col shrink-0 border-r border-border bg-sidebar transition-[width] duration-200 ease-in-out overflow-hidden",
            ...
            >
                    ...
                    {SECTIONS.map((section, i) => (
                        <div key={section.title}>
                            {!collapsed ? (
                                ...
                                i > 0 && (
                                    <div className="my-2 h-px bg-sidebar-item-active mx-1" />
                                )
                            )}
                ...
                {!collapsed && (
                    <button
                        ...
                        className="flex items-center gap-2 border-t border-border px-3 py-2 text-xs text-muted-foreground hover:text-foreground transition-colors shrink-0"
                        title={
                            isDark
            ...
            {/* Main */}
            <main className="flex-1 overflow-y-auto bg-main-bg [scrollbar-gutter:stable]">
                {children}
            </main>
        </div>
    );
